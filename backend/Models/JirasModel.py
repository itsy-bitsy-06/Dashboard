...
class JirasModel(db.Model):
    ...
    Status = db.Column(db.String(32), nullable=False)                   # Status of this jira
    Description = db.Column(db.String(16384))                           # Description for this group
    ...
    CustomerRequestType = db.Column(db.String(32), nullable=False)      # Request Type
